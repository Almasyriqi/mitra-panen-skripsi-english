        ...
        <div class="card-body fs-6 text-gray-700">
            ...
            <div class="mb-5">
                ...
                <div class="image-input image-input-outline" data-kt-image-input="true"
                    style="background-image: url({{$user->avatar_image}})">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="joined_since" id="joined_since"
                                value="{{$user->joined_since}}" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="footer d-flex justify-content-end py-10">
                <div class="d-flex justify-content-end">
                    <button id="cancelButton" type="button" class="btn btn-light btn-active-light-primary me-3">Batalkan</button>
...
<script>
    ...
    const enableForm = () => {
        $('#edit').hide();
        $('#btn_edit_avatar').show();
        $('#btn_cancel_avatar').show();
        $('#btn_remove_avatar').show();
    ...
    const disableForm = () => {
        $('#edit').show();
        $('#btn_edit_avatar').hide();
        $('#btn_cancel_avatar').hide();
